...
$url7 = "https://raw.githubusercontent.com/charliehoward/CRC-Installer-PS/master/ExitR.ps1"
$path7 = "C:\Windows\Computer Repair Centre\ExitR.ps1"
...
$form1.Text = "CRC Installer PS Romsey v1.5.2"
$form1.Name = "form1"
