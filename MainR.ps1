...
$handler_button1_Click= 
{
	...
	if ($checkBox1.Checked)     {
		...
		Set-ItemProperty -path HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\OEMInformation -name SupportPhone -value "TBD"
...
$form1.Text = "BRM Installer PS Romsey v1.0.0"
$form1.Name = "form1"
